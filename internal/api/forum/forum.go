...
func (f *Forum) Route(r app.Router) {
	// TODO
	r.Methods("GET").WebOnlyHandlerFunc("/forum", f.getForum)
	r.Methods("GET").WebOnlyHandlerFunc("/forum/tags", f.getTags)
	r.Methods("GET").WebOnlyHandlerFunc("/forum/threads", f.getThreads)
}
